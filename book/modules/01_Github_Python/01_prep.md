...
* Review the [syllabus](https://docs.google.com/document/d/1LMJwNlEgIYr3xlGU84sYdcK0F35qXbUzDvH_CjTNv3w/edit?usp=sharing) and [Code of Conduct](../../resources/code_of_conduct.md)
    * Access is restricted to UW Google accounts!
* Fill out the [background questionnaire](https://docs.google.com/forms/d/e/1FAIpQLSdvsaNlctr_8UaPL2_uIs2fRR1097O8Oiv4bTzDgPi6PhQLZw/viewform?usp=sharing&ouid=109959221683421850946) (access with UW Google account)
...
### 1. Navigating the command line (~5-10 min)
* [Bash Commands to Manage Directories and Files](https://www.earthdatascience.org/courses/intro-to-earth-data-science/open-reproducible-science/bash/bash-commands-to-manage-directories-files/)
...
* If you’ve never worked with git and github, it’s going to be confusing at first. Please do your best to understand the basics. Review and work through these introductory guides (or search the web for other introductory material):
    * [Lesson 4. Get Started with Git Commands for Version Control](https://www.earthdatascience.org/courses/intro-to-earth-data-science/git-github/version-control/git-commands/)
* Optional: If you'd like to get more practice, review the table of contents for the [Software Carpentry Git Novice lessons](http://swcarpentry.github.io/git-novice/) and decide for yourself which components will be most valuable based on your experience

### 3. A Whirlwind Tour of Python (~2 hours)
* Now that you've learned the basics of git, you can use the git clone command to download the [Whirlwind Tour of Python](https://github.com/jakevdp/WhirlwindTourOfPython/tree/master) tutorial to your jupyterhub
